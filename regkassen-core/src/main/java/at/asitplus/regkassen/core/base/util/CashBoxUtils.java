...
public class CashBoxUtils {
    ...
    /**
     * convert JWS compact representation to OCR-machine-code representation of signed receipt
     *
     * @param jwsCompactRepresentationOfReceipt JWS compact representation of signed receipt
    ...
    public static String getOCRCodeRepresentationFromJWSCompactRepresentation(String jwsCompactRepresentationOfReceipt) {
        ...
        //could be done more efficiently, but in this way the process of converting the QR representation to the OCR representation is highlighted
        ...
        String ocrCodeRepresentation =
                "_" + el1_rkSuite +
                "_" + el2_cashboxID +
                "_" + el3_receiptIdentifier +
                "_" + el4_timeAndDate +
                "_" + el5_taxSet_NORMAL +
                "_" + el6_taxSet_ERMAESSIGT1 +
                "_" + el7_taxSet_ERMAESSIGT2 +
                "_" + el8_taxSet_NULL +
                "_" + el9_taxSet_BESONDERS +
                "_" + el10_encryptedTurnOverValue +
                "_" + el11_certificateSerialNumberOrCompanyAndKeyID +
                "_" + el12_chainValue +
                "_" + el13_signatureValue;
