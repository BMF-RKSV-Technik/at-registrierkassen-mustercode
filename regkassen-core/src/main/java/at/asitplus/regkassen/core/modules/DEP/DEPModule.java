...
/**
 * Simple interface for DEP module. The main tasks of this module
 * store and retrieve receipts
 * retrieve last stored receipt (used for chaining receipts)
 * export DEP according to Detailspezifikation Abs 3
 */
